...
public class BirdVehicle : BaseVehicle
{
    ...
    [Tooltip("How fast the bird aligns to the camera during flight.")]
    public float flightPitchYawSpeed = 50f;
    [Tooltip("How much A/D input physically rolls the bird.")]
    public float flightRollSensitivity = 30f;
